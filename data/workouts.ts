    ...
    muscleGroups: [
      {
        ...
        recommended: [
          ...
          { name: 'Chest Dips', sets: 3, reps: 12, muscle: 'Lower Chest', equipment: 'Dip Station', gifUrl: '/gifs/bench-dip.gif' },
        ]
      },
      {
        name: 'SHOULDERS',
        exercises: [
          ...
          { name: 'Rear Delt DB Flyes', sets: 3, reps: 15, muscle: 'Rear Delts', equipment: 'Dumbbells', gifUrl: '/gifs/rear-delt-fly.gif' },
        ],
        recommended: [
      ...
      },
      {
        name: 'BICEPS',
        exercises: [
          { name: 'Seated Bicep Curls', sets: 3, reps: 12, muscle: 'Biceps', equipment: 'Dumbbells + Bench', gifUrl: '/gifs/seated-dumbbell-curl.gif' },
        ...
        recommended: [
          ...
          { name: 'Preacher Curl', sets: 3, reps: 12, muscle: 'Lower Bicep', equipment: 'EZ Bar + Preacher', gifUrl: '/gifs/barbell-preacher-curl.gif' },
        ]
      },
    ]
  },
    ...
    muscleGroups: [
      {
        ...
        exercises: [
          ...
          { name: 'Leg Press', sets: 3, reps: 12, muscle: 'Quads', equipment: 'Leg Press Machine', gifUrl: '/gifs/leg-press.gif' },
        ],
        recommended: [
          { name: 'Bulgarian Split Squats', sets: 3, reps: 10, muscle: 'Quads + Glutes', equipment: 'Dumbbells + Bench', gifUrl: '/gifs/dumbbell-split-squat.gif' },
      ...
      },
      {
        name: 'CALVES',
        exercises: [
          { name: 'Standing Calf Raises', sets: 4, reps: 15, muscle: 'Calves', equipment: 'Machine/Bodyweight', gifUrl: '/gifs/standing-calf-raise.gif' },
        ],
        recommended: [
          { name: 'Seated Calf Raise', sets: 3, reps: 20, muscle: 'Soleus', equipment: 'Machine', gifUrl: '/gifs/seated-calf-raise.gif' },
        ]
      },
      {
        name: 'ABS',
        exercises: [
          { name: 'Hanging Leg Raises', sets: 3, reps: 15, muscle: 'Lower Abs', equipment: 'Pull-Up Bar', gifUrl: '/gifs/hanging-leg-raise.gif' },
          { name: 'Bicycle Crunches', sets: 3, reps: 20, muscle: 'Obliques', equipment: 'Bodyweight', gifUrl: '/gifs/bicycle-crunch.gif' },
          { name: 'Plank', sets: 3, reps: '60s', muscle: 'Core', equipment: 'Bodyweight', gifUrl: '/gifs/front-plank.gif' },
        ],
        recommended: [
    ...
    muscleGroups: [
      {
        ...
        exercises: [
          ...
          { name: 'Rear Delt Flyes', sets: 3, reps: 15, muscle: 'Rear Delts', equipment: 'Dumbbells', gifUrl: '/gifs/rear-delt-fly.gif' },
        ...
        recommended: [
          ...
          { name: 'T-Bar Row', sets: 3, reps: 10, muscle: 'Mid Back', equipment: 'T-Bar', gifUrl: '/gifs/t-bar-row.gif' },
        ]
      },
      {
        name: 'TRICEPS',
        exercises: [
          { name: 'Overhead DB Extensions', sets: 3, reps: 12, muscle: 'Long Head', equipment: 'Dumbbell', gifUrl: '/gifs/skull-crusher.gif' },
          { name: 'DB Kickbacks', sets: 3, reps: 12, muscle: 'Lateral Head', equipment: 'Dumbbell', gifUrl: '/gifs/bench-dip.gif' },
          { name: 'Skull Crushers', sets: 3, reps: 12, muscle: 'Triceps', equipment: 'EZ Bar + Bench', gifUrl: '/gifs/skull-crusher.gif' },
        ...
        recommended: [
          ...
          { name: 'Dips', sets: 3, reps: 10, muscle: 'Triceps', equipment: 'Dip Station', gifUrl: '/gifs/bench-dip.gif' },
        ]
      },
    ]
  },
    ...
    muscleGroups: [
      {
        ...
        exercises: [
          { name: 'Rope Pushdowns', sets: 3, reps: 15, muscle: 'Triceps', equipment: 'Cable Machine', gifUrl: '/gifs/pushdown.gif' },
          { name: 'Overhead Cable Extension', sets: 3, reps: 12, muscle: 'Long Head', equipment: 'Cable Machine', gifUrl: '/gifs/skull-crusher.gif' },
          { name: 'Diamond Push Ups', sets: 3, reps: 10, muscle: 'Triceps', equipment: 'Bodyweight', gifUrl: '/gifs/diamond-push-up.gif' },
        ],
        recommended: [
          { name: 'Bench Dips', sets: 3, reps: 15, muscle: 'Triceps', equipment: 'Bench', gifUrl: '/gifs/bench-dip.gif' },
        ]
      },
      {
        name: 'BICEPS',
        exercises: [
          ...
          { name: 'Incline DB Curls', sets: 3, reps: 12, muscle: 'Long Head', equipment: 'Dumbbells + Incline Bench', gifUrl: '/gifs/incline-dumbbell-curl.gif' },
          { name: 'Spider Curls', sets: 3, reps: 10, muscle: 'Short Head', equipment: 'EZ Bar + Incline Bench', gifUrl: '/gifs/barbell-spider-curl.gif' },
        ],
        recommended: [
          { name: 'Cable Curl', sets: 3, reps: 15, muscle: 'Biceps', equipment: 'Cable Machine', gifUrl: '/gifs/cable-curl.gif' },
        ]
      },
      {
        name: 'FOREARMS',
        exercises: [
          { name: 'Wrist Curls', sets: 3, reps: 20, muscle: 'Forearm Flexors', equipment: 'Barbell/Dumbbells', gifUrl: '/gifs/wrist-curl.gif' },
          ...
          { name: 'Farmers Walk', sets: 3, reps: '30s', muscle: 'Grip Strength', equipment: 'Heavy Dumbbells', gifUrl: '/gifs/farmers-walk.gif' },
        ],
        recommended: [
          { name: 'Dead Hangs', sets: 3, reps: '30s', muscle: 'Grip', equipment: 'Pull-Up Bar', gifUrl: '/gifs/dead-hang.gif' },
        ]
      },
    ]
  },
    ...
    muscleGroups: [
      {
        ...
        exercises: [
          ...
          { name: 'Incline DB Flyes', sets: 3, reps: 12, muscle: 'Upper Chest', equipment: 'Dumbbells + Incline Bench', gifUrl: '/gifs/incline-dumbbell-fly.gif' },
